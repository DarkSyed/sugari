...
const AddA1CScreen: React.FC = () => {
  ...
  const handleSubmit = () => {
    // TODO: Implement A1C tracking functionality
    console.log('A1C submitted:', { 
      a1cValue, 
  ...
  return (
    <Container>
      <View style={styles.header}>
        <Text style={styles.title}>Log A1C</Text>
      </View>

      <Card variant="elevated" style={styles.card}>
        <Text style={styles.label}>A1C Value (%)</Text>
        <Input
          placeholder="Enter A1C value (e.g. 6.5)"
          value={a1cValue}
          onChangeText={setA1cValue}
          keyboardType="decimal-pad"
        />

        <Text style={styles.label}>When was this test taken?</Text>
