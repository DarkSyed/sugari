...
import { addBloodSugarReading } from '../../services/supabase';
...
const AddSugarScreen: React.FC = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    setIsLoading(true);
    try {
      const sugarValue = parseFloat(data.value);
      ...
      const { error } = await addBloodSugarReading(reading);
  ...
  return (
    <Container>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Record your blood sugar reading</Text>
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <View style={styles.sugarInputContainer}>
                <Input
                  ...
                  touched={value !== ''}
                  containerStyle={styles.sugarInput}
                />
